...
class Keychain_RSATestsiOS13Device: InteractiveTestCaseiOS13Device {
    ...
    func testQueryWithApplicationPassword() throws {
        ...
        _ = try Keychain.queryKey(for: publicKey, authentication: authentication) as Crypto.RSA.PrivateKey?
    }
    ...
    func testQueryWithUserPresence() throws {
        ...
        _ = try Keychain.queryKey(for: publicKey) as Crypto.RSA.PrivateKey?
    }
