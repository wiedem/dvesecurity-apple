...
If a Swift version of 5.5 or higher is used, a [DocC] documentation is also automatically generated. Further details can be found in the [Documentation](#Documentation) section.
...
## Testing
The Xcode project of the framework contains automatic and manual tests to test the functionality.
A majority of the tests require a host application with an application identifier to run. The project includes host applications for iOS and macOS for this purpose.
...
The team identifier for the development team can be found in the Apple developer account.
...
The generated DocC documentation includes "Getting Started" articles and code samples in addition to the API documentation.

## Compatibility
DVESecurity is compatible with iOS 12.3, macOS 10.15 and requires at least Swift 5.4.
